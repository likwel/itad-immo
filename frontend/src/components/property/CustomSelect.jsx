 ...
 * @param {string}   padding     — padding du trigger
 * @param {string}   minWidth    — largeur minimale du composant
 */
    ...
    <div ref={ref} style={{ position: 'relative', minWidth }}>
      ...
      >
        ...
        <Icon d={CHEV} size={14} style={{
          color: '#94a3b8', flexShrink: 0, marginLeft: 8,
        ...
        <div style={{
          ...
          {options.map(([v, l]) => (
            <div
              ...
              style={{
                padding, fontSize: 13, cursor: 'pointer',
            ...
            >
              {l}
              {v === value && <Icon d={CHECK} size={13} style={{ marginLeft: 8, flexShrink: 0 }}/>}
            </div>
          ))}
        </div>
      )}
